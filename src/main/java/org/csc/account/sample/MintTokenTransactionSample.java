...
@Slf4j
@Data
public class MintTokenTransactionSample extends SessionModules<ReqCreateTransactionTest> {
	...
	public String[] getCmds() {
		return new String[] { PTSTCommand.MTO.name() };
	}
	...
	public void onPBPacket(final FramePacket pack, final ReqCreateTransactionTest pb, final CompleteHandler handler) {
		...
		try {
			...
			oMultiTransactionBody.setType(TransTypeEnum.TYPE_MintToken.value());
