...
@Slf4j
@Data
public class BurnTokenTransactionSample extends SessionModules<ReqCreateTransactionTest> {
	...
	public String[] getCmds() {
		return new String[] { PTSTCommand.BTO.name() };
	}
	...
	public void onPBPacket(final FramePacket pack, final ReqCreateTransactionTest pb, final CompleteHandler handler) {
		...
		try {
			...
			oMultiTransactionBody.setType(TransTypeEnum.TYPE_BurnToken.value());
